# Generated by Django 2.0.5 on 2018-05-22 14:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificado', models.UUIDField(default=uuid.UUID('3e294ca7-b773-4bc3-ac06-f794a892ed66'), editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identificado', models.UUIDField(default=uuid.UUID('240d50dc-ee85-4564-afb6-64320f33bf2e'), editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identificado', models.UUIDField(default=uuid.UUID('3d38117e-e3c9-4605-a05a-6e36cb2d7d2a'), editable=False)),
                ('nome', models.CharField(max_length=255)),
